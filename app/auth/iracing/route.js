...
export async function GET(request) {
  ...
  // returnTo — path to redirect back to after sync (e.g. /pilotes/123 or /inventaire)
  // Defaults to /pilotes if not provided. Must not contain | (used as state separator).
