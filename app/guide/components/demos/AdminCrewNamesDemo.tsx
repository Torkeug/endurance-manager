    ...
    <div>
      ...
      <div style={{ padding: "1rem", background: "var(--surface-2)", marginBottom: "0.75rem", borderRadius: "3px" }}>
        <div style={{ display: "flex", gap: "0.75rem", alignItems: "flex-end", flexWrap: "wrap" }}>
          <div style={{ flex: 1, minWidth: "160px" }}>
            <div style={{ fontSize: "0.75rem", fontWeight: 700, marginBottom: "0.3rem", color: "var(--text-dim)", textTransform: "uppercase", letterSpacing: "0.06em" }}>{t("crewNameAddLabel")}</div>
          ...
          <button className="btn btn-secondary btn-sm">{t("cancel")}</button>
        </div>
        {/* Color picker preview */}
        <div style={{ marginTop: "0.75rem" }}>
          <div style={{ fontSize: "0.75rem", fontWeight: 700, marginBottom: "0.4rem", color: "var(--text-dim)", textTransform: "uppercase", letterSpacing: "0.06em" }}>{t("crewColorLabel")}</div>
          <div style={{ display: "flex", alignItems: "center", gap: "0.6rem", flexWrap: "wrap" }}>
            ...
            <button className="btn btn-secondary btn-sm">{t("crewClearColor")}</button>
      ...
      <div className="table-wrap">
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr>
              <th style={TH}>{t("crewColName")}</th>
              <th style={TH}>{t("crewColColor")}</th>
              <th style={TH}></th>
            </tr>
          </thead>
          <tbody>
              ...
              <tr key={c.name}>
                ...
                <td style={TD}>
                  {c.color ? (
                    ...
                    <span style={{ color: "var(--text-dim)", fontSize: "0.82rem" }}>{t("crewAutoColor")}</span>
                  )}
                </td>
                <td style={TD}>
