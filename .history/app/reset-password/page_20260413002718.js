  ...
  const handleSubmit = async (e) => {
    ...
    if (err) {
      if (
        ...
        setError(
          "Trop d'emails envoyés. Attendez quelques minutes avant de réessayer.",
        );
      } else {
          ...
          {sent ? (
            <div style={{ textAlign: "center" }}>
              ...
              >
                ...
                <strong style={{ color: "var(--text)" }}>{email}</strong>, un
                lien de réinitialisation a été envoyé. Vérifiez également vos
                spams.
              </p>
              <Link
                href="/login"
