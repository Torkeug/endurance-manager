      ...
      {admin && (
        <div style={{
          ...
          {[
            ...
            { label: 'Pilotes test', value: testDrivers || 0, color: 'var(--text-dim)' },
            { label: 'Cotisation expirée', value: overdueMembers || 0, color: overdueMembers > 0 ? 'var(--danger)' : 'var(--text-dim)' },
