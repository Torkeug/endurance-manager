...
// iRacing OAuth callback — account linking only, not login.
// Links the iRacing ID and iRating to the existing logged-in driver record.
export async function GET(request) {
  ...
  try {
    ...
    // Check if this iRacing ID is already linked to a different account before saving.
