        ...
        <div className="card">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', margin: '1rem 0' }}>
              ...
              <span style={{ fontSize: '0.78rem', color: 'var(--text-dim)' }}>ou</span>
              <div style={{ flex: 1, height: '1px', background: 'var(--border)' }} />
            </div>

            <a href="/auth/iracing" className="btn btn-secondary" style={{ width: '100%', textAlign: 'center', display: 'block' }}>
              🏎️ Connexion avec iRacing
            </a>
          </form>
