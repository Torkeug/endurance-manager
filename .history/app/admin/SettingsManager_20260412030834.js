      ...
      <div className="card">
        ...
        {specialTimes.length > 0 && (
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                {specialTimes.map(st => (
                    <tr key={st.id} style={{ opacity: savingSpecial === st.id ? 0.5 : 1 }}>
                    <td style={TD} className="mono" style={{ fontWeight: 600, color: 'var(--accent)' }}>
                    ...
                    <td style={{ ...TD, textAlign: 'right' }}>
                        ...
                        className="btn btn-danger btn-sm" disabled={savingSpecial === st.id}>
                        Supprimer
                        </button>
                    </td>
                    </tr>
