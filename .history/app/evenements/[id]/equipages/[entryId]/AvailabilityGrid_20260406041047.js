...
export default function AvailabilityGrid({
  ...
  const getRowStyle = (slot) => {
    if (isRaceStart(slot)) return { background: 'rgba(46,180,96,0.10)', borderTop: '3px solid #2eb460' }
    if (isRaceEnd(slot))   return { background: 'rgba(224,85,85,0.08)', borderTop: '3px solid var(--danger)' }
