...
function displayToSec(str) {
  ...
  const ms = parseFloat(`0.${match[3].padEnd(3, '0')}`)
  return m * 60 + s + ms
}
                ...
                <div className="form-group">
                  <label>Chrono (MM:SS.mmm)</label>
                    ...
                    onBlur={e => setForm(prev => ({
                        ...prev,
                        lap_time_dry: secToDisplay(displayToSec(e.target.value)) || e.target.value
                    }))}
              ...
              <div className="form-grid">
                <div className="form-group">
                  <label>Chrono (MM:SS.mmm)</label>
                    ...
                    onBlur={e => setForm(prev => ({
                        ...prev,
                        lap_time_wet: secToDisplay(displayToSec(e.target.value)) || e.target.value
                    }))}
