              ...
              <div className="form-grid">
                <div className="form-group">
                  <label>Chrono (MM:SS.mmm)</label>
                    ...
                    onChange={e => { set('lap_time_dry')(e); setLapDryError(false) }}
                    onBlur={() => {
                        if (!form.lap_time_dry.trim()) { setLapDryError(false); return }
                    ...
                    style={{ borderColor: lapDryError ? 'var(--danger)' : undefined }}
                    />
                    {lapDryError && (
              ...
              <div className="form-grid">
                <div className="form-group">
                  <label>Chrono (MM:SS.mmm)</label>
                    ...
                    onChange={e => { set('lap_time_wet')(e); setLapWetError(false) }}
                    onBlur={() => {
                        if (!form.lap_time_wet.trim()) { setLapWetError(false); return }
                        const sec = displayToSec(form.lap_time_wet)
                        if (sec !== null) {
                        setForm(prev => ({ ...prev, lap_time_wet: secToDisplay(sec) }))
                        setLapWetError(false)
                        } else {
                        setLapWetError(true)
                        }
                    ...
                    style={{ borderColor: lapWetError ? 'var(--danger)' : undefined }}
                    />
                    {lapWetError && (
                    <span style={{ fontSize: '0.75rem', color: 'var(--danger)' }}>
