              ...
              <div className="form-grid">
                <div className="form-group">
                  <label>Chrono (MM:SS.mmm)</label>
                    ...
                    onChange={set('lap_time_dry')}
                    onBlur={() => {
                        const sec = displayToSec(form.lap_time_dry)
                        if (sec !== null) setForm(prev => ({ ...prev, lap_time_dry: secToDisplay(sec) }))
                    }}
              ...
              <div className="form-grid">
                <div className="form-group">
                  <label>Chrono (MM:SS.mmm)</label>
                    ...
                    onChange={set('lap_time_wet')}
                    onBlur={() => {
                        const sec = displayToSec(form.lap_time_wet)
                        if (sec !== null) setForm(prev => ({ ...prev, lap_time_wet: secToDisplay(sec) }))
                    }}
