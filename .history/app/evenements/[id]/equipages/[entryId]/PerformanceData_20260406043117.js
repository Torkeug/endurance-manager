          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem', marginBottom: '1.25rem' }}>
            ...
            <div>
              ...
              <div className="form-grid">
                <div className="form-group">
                  ...
                  <input type="text" value={form.lap_time_dry} onChange={e => setForm(prev => ({ ...prev, lap_time_dry: formatLapInput(e.target.value) }))}
            ...
            <div>
              ...
              <div className="form-grid">
                <div className="form-group">
                  <label>Chrono (MM:SS.mmm)</label>
                  <input type="text" value={form.lap_time_wet} onChange={e => setForm(prev => ({ ...prev, lap_time_wet: formatLapInput(e.target.value) }))}
