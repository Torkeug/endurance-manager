...
export default function ModifierEvenement({ params }) {
  ...
  const isPreset = form ? durations.some(d => d.minutes === form.duration_minutes) : false
            ...
            <div className="form-group" style={{ gridColumn: '1 / -1' }}>
              ...
              <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginBottom: '0.5rem' }}>
                {durations.map(({ minutes }) => (
                  <button key={minutes} type="button" onClick={() => { setDuration(minutes); setCustomH(''); setCustomM('') }}
