...
const emptyForm = {
  name:           '',
  date:           '',
  irl_start_date: '',   // separate date field for IRL start
  irl_start_time: '',   // separate time field for IRL start (24h)
  duration_hours: '',
  circuit_id:     '',
  format:         '',
  ig_start_time:  '',
...
export default function NouvelEvenement() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Combine date + time into a timestamp string
    let irl_start = null
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="card" style={{ marginBottom: '1.25rem' }}>
          ...
          <div className="form-grid">
            ...
            {/* IRL start — split into date + time */}
            <div className="form-group">
