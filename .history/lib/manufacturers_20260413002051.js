...
const MANUFACTURER_LOGOS = {
  ...
  // Dallara: no logo available from this CDN — null prevents broken image requests
  Dallara: null,
...
// MATCH_ORDER controls priority — longer/more specific names (e.g. "Mercedes-AMG")
// must be checked before shorter ones ("Mercedes") to avoid false matches.
const MATCH_ORDER = [
  "Mercedes-AMG",
  "Aston Martin",
  "Acura",
